  ...
  return (
    <div className="w-full min-h-screen pb-10 bg-neutral-50 text-white">
      ...
      <main className="w-full max-w-md mx-auto px-4 pt-5 pb-10 flex flex-col items-center gap-6">
        ...
        <a href="https://chat.whatsapp.com/EnFKpPQLoAvHrYJKPN8yqH" target="_blank" className="bg-neutral-800 text-white font-semibold rounded-3xl py-3 px-6 text-center text-sm flex items-center gap-2">
          <Users size={18} />
        ...
        <div className="flex flex-col items-center gap-2 w-full">
          <a href="https://chat.whatsapp.com/EnFKpPQLoAvHrYJKPN8yqH" target="_blank" className="bg-gradient-to-r bg-green-500 to-green-600 text-white font-bold rounded-3xl py-4 px-6 text-center w-full max-w-sm animate-scale hover:bg-none hover:bg-green-600 cursor-pointer">
